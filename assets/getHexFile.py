...
text = open('memory_content.txt','w')
hexfile = open('content.hex','w')

read_rgb_8_bit('./640x480/background.jpg','./640x480/converted/background.jpg', text, hexfile)
read_rgb_8_bit('./640x480/fighter1.png','./640x480/converted/fighter1.png', text, hexfile)
